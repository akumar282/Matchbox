...
export default function InboxMessage(props: InboxMessageProps) {
  ...
  return (
    <button
      ...
      className={`w-full h-max flex items-center font-primary space-x-2 gap-4 py-1 hover:bg-[#ececec] rounded-lg ${props.isSelected ? 'bg-[#ececec]' : ''}`}
    >
      <div className='pl-2 flex flex-row items-center space-x-2'>
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' width={36} height={36} viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor'
          className='w-[3rem]'>
