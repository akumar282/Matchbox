...
export default function UsersModelCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setUser_creation_date(initialValues.user_creation_date);
    setDahublink(initialValues.dahublink);
    setSaved_posts(initialValues.saved_posts);
    setCurrentSaved_postsValue("");
    setHide_posts(initialValues.hide_posts);
